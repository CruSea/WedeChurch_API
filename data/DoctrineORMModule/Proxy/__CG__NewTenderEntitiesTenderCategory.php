 ...
 */
class Category extends \NewTender\Entities\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'tenderGroup', 'name', 'language', 'description', 'isDeleted', 'isActive', 'updatedBy', 'updatedDate', 'createdBy', 'createdDate'];
        }
     ...
     * {@inheritDoc}
     */
    public function getTenderGroup()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTenderGroup', []);

        return parent::getTenderGroup();
    }

    /**
     * {@inheritDoc}
     */
    public function setTenderGroup($tenderGroup)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTenderGroup', [$tenderGroup]);

        return parent::setTenderGroup($tenderGroup);
    }
