...
namespace DoctrineORMModule\Proxy\__CG__\BuildingManagement\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Floor extends \BuildingManagement\Entities\Floor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'building', 'name', 'description', 'isDeleted', 'isActive', 'updatedBy', 'updatedDate', 'createdBy', 'createdDate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Floor $proxy) {
